...
import { UfData, ApiUfResponse } from '../../shared/interfaces/ufs.interfaces'
...
@Component({
  ...
  styleUrl: './ufs.component.scss'
})
export class UfsComponent {
data: UfData[] = [];
environment = environment;
  ...
  apiRequest() {
      ...
      if (token && userId) {
        ...
        this.http
          .get<ApiUfResponse>(`${this.environment.apiURL}/${this.crudConfig.apiRoute}`, { headers })
          .subscribe(
